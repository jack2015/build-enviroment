...
IMAGE_CMD_jffs2 = " \
	...
	zip -j ${DEPLOY_DIR_IMAGE}/${DISTRO_NAME}-${DISTRO_VERSION}-${MACHINE}-${MACHINESIMS}-${PDATE}.zip ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.nfi; \
...
IMAGE_CMD_ubifs = " \
	...
	${DREAMBOX_BUILDIMAGE} \
		...
		> ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.nfi; \
	rm -f ${DEPLOY_DIR_IMAGE}/*.zip; \
	zip -j ${DEPLOY_DIR_IMAGE}/${DISTRO_NAME}-${DISTRO-VERSION}-${MACHINE}-${MACHINESIMS}-${PDATE}.zip ${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.nfi; \
	rm -f ${DEPLOY_DIR_IMAGE}/*.nfi; \
"
